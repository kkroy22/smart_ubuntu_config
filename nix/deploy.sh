...
touch ~/.vimrc
echo "so $HOME/bundle/git/My-Sweet-Little-Sys/nix/dotfile/vim/vim-man.vim" >> ~/.vimrc

touch ~/.tmux.conf
echo "source-file $HOME/bundle/git/My-Sweet-Little-Sys/nix/dotfile/tmux/tmux-man.conf" >> ~/.tmux.conf
...
echo "source ~/bundle/git/My-Sweet-Little-Sys/nix/dotfile/bash/bash-man.sh" >> ~/.bashrc
...
echo "source ~/bundle/git/My-Sweet-Little-Sys/nix/dotfile/zsh/zsh-man.sh" >> ~/.zshrc
